...
public interface CurvePointService {
	...
	CurvePoint saveCurvePoint(CurvePoint curvePointToSave, WebRequest request) throws ResourceConflictException, ResourceNotFoundException, UnexpectedRollbackException;
